...
Strike #7: extend self_features 16 → 29 by adding sister's v6 cell-internal
...
- features-csv: all_designs_with_cell.csv (62 cols, +13 cell features)
...
# Extended self features: original 16 + 13 cell-internal
_SELF_FEATURE_COLS_EXT = [
    ...
    "fanout",
    "aspect_ratio",
    # ---- new 13 cell-internal features (sister v6) ----
    "n_pins_obs_matched",
    "v6_cell_size_w_sum",
    "v6_cell_size_h_sum",
    "v6_cell_area_sum",
    ...
    "v6_n_pins_input",
    "v6_n_pins_output",
    "v6_obs_signal_nsq_M1",
    "v6_obs_signal_area_M1",
    "v6_obs_n_via_v0_pin",
    "v6_obs_signal_nsq_M2",
    "v6_obs_signal_area_M2",
    "v6_obs_n_via_v1_pin",
]
SELF_DIM_EXT = len(_SELF_FEATURE_COLS_EXT)  # 29
...
def parse_args():
    ...
    p.add_argument(
        ...
        default=_PROJECT_ROOT / "pex_v3" / "output" / "phase1_mesh_with_cell_smoke",
    )
...
def main():
    ...
    print(f">>> Strike #7 mesh + cell features — seed {args.seed}")
    print(f">>> features:  {args.features_csv}")
    print(f">>> cuboids:   {args.cuboid_dir}")
    print(f">>> output:    {args.output_dir}")
    print(f">>> device:    {args.device}")
    print(f">>> self_dim:  {SELF_DIM_EXT} (was 16, +13 cell features)")
    ...
    snap["task"] = "phase1_mesh_with_cell_smoke"
    ...
    print()
    print("=" * 60)
    print(f">>> CELL FEATURE STRIKE RESULT")
